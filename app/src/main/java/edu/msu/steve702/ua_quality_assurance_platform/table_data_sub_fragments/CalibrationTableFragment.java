...
/**
 * CalibrationTableFragment Class
 * A simple {@link Fragment} subclass.
 * A fragment that represents a calibration table tab within the table data fragment in the AuditAcitvity Class.
 * This fragment view is a subfragment.
 */
public class CalibrationTableFragment extends Fragment {
    ...
    /** The calibration table data object and its respective Getter and Setter **/
     ...
     * Empty Constructor
     */
    public CalibrationTableFragment() {
     ...
     * @return A new instance of fragment CalibrationTableFragment.
     */
    public static CalibrationTableFragment newInstance(String param1, String param2) {
        CalibrationTableFragment fragment = new CalibrationTableFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_calibration_table, container, false);
    }
     ...
     * @return a calibration table data object
     */
    public CalibrationTableDataObject bundleObject() {
        ...
        List<String> row15 = getRow(15);

        CalibrationTableDataObject newObject = new CalibrationTableDataObject(
                row1,
                row2,
                row3,
                row4,
