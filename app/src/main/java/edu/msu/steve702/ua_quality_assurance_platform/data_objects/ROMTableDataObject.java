...
/**
 * ROMTableDataObject Class
 * Serializable Object that represents the data for ROM table within an Audit.
 * Used for database management.
 */
public class ROMTableDataObject implements Serializable {
    ...
    /** Empty Constructor **/
    public ROMTableDataObject() {
    }

    /** Constructor **/
    public ROMTableDataObject(List<String> row1,
                              List<String> row2,
                              List<String> row3,
                              List<String> row4,
                              List<String> row5,
