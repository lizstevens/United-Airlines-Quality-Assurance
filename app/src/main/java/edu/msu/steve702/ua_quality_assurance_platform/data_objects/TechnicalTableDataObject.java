...
/**
 * TechnicalTableDataObject Class
 * Serializable Object that represents the data for Technical Data table within an Audit.
 * Used for database management.
 */
public class TechnicalTableDataObject implements Serializable {
    ...
    private List<String> row12;
    private List<String> row13;
    private List<String> row14;

    /** Empty Constructor **/
    public TechnicalTableDataObject() {
    }

    /** Constructor **/
    public TechnicalTableDataObject(List<String> row1,
                                      List<String> row2,
                                      List<String> row3,
                                      List<String> row4,
                                      List<String> row5,
