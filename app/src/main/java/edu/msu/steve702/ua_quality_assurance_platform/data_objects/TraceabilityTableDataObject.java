...
/**
 * TraceablityTableDataObject Class
 * Serializable Object that represents the data for Traceability table within an Audit.
 * Used for database management.
 */
public class TraceabilityTableDataObject implements Serializable {
    ...
    /** Empty Constructor **/
    public TraceabilityTableDataObject() {}

    /** Constructor **/
    public TraceabilityTableDataObject(List<String> row1,
                                   List<String> row2,
                                   List<String> row3,
                                   List<String> row4,
                                   List<String> row5,
