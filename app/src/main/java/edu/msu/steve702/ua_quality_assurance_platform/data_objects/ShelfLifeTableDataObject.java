...
/**
 * ShelfLifeTableDataObject Class
 * Serializable Object that represents the data for Shelf Life table within an Audit.
 * Used for database management.
 */
public class ShelfLifeTableDataObject implements Serializable {
    ...
    /** Empty Constructor **/
    public ShelfLifeTableDataObject() {
    }

    /** Constructor **/
    public ShelfLifeTableDataObject(List<String> row1,
                                    List<String> row2,
                                    List<String> row3,
                                    List<String> row4,
                                    List<String> row5,
